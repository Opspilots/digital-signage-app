# Graph Report - /var/www/digital-signage-app  (2026-06-06)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 691 nodes · 806 edges · 32 communities (30 shown, 2 thin omitted)
...
- [[_COMMUNITY_Media Processing Functions|Media Processing Functions]]
...
- [[_COMMUNITY_Node.js Configuration|Node.js Configuration]]
- [[_COMMUNITY_Backup Script|Backup Script]]
- [[_COMMUNITY_Deployment Script|Deployment Script]]
- [[_COMMUNITY_CICD Implementation|CI/CD Implementation]]
- [[_COMMUNITY_QA Initiative Summary|QA Initiative Summary]]
- [[_COMMUNITY_Bug Reports & Specifications|Bug Reports & Specifications]]
- [[_COMMUNITY_QA Executive Summary|QA Executive Summary]]
- [[_COMMUNITY_Manual QA Testing Checklist|Manual QA Testing Checklist]]
...
10. `Digital Signage - Manual QA Testing Checklist` - 12 edges
...
Cohesion: 0.14
Nodes (13): dataDir, db, DB_PATH, existingAdmin, itemsInfo, itemsInfo2, mediaInfo, mediaInfo2 (+5 more)
...
### Community 8 - "Media Processing Functions"
Cohesion: 0.12
Nodes (9): ALLOWED_MIME_TYPES, MAGIC_BYTES, parseFps(), router, storage, THUMBNAILS_DIR, upload, UPLOADS_DIR (+1 more)

### Community 9 - "Schedule Management"
Cohesion: 0.36
Nodes (5): DAY_BITS, minuteInRange(), router, schedulesOverlap(), timeToMinutes()
...
### Community 12 - "Node.js Configuration"
Cohesion: 0.25
Nodes (7): compilerOptions, allowSyntheticDefaultImports, composite, module, moduleResolution, skipLibCheck, include

### Community 20 - "CI/CD Implementation"
Cohesion: 0.05
...
### Community 21 - "QA Initiative Summary"
Cohesion: 0.05
...
### Community 23 - "QA Executive Summary"
Cohesion: 0.06
...
### Community 24 - "Manual QA Testing Checklist"
Cohesion: 0.06
...
### Community 28 - "Authentication API"
Cohesion: 0.21
Nodes (10): AuthPayload, isScreenTokenAllowed(), requireAdmin(), requireAuth(), revokedRefreshJtis, router, UserRow, router (+2 more)

### Community 29 - "Screen Management"
Cohesion: 0.29
Nodes (6): formatScreen(), isOnline(), pairNewLimiter, router, ScheduleRow, screensPublicRouter

### Community 30 - "Playlist Management"
Cohesion: 0.40
Nodes (3): formatItem(), router, updateItem()

### Community 31 - "Application Setup"
Cohesion: 0.33
Nodes (4): app, DEPLOY_SCRIPT, UPLOADS_DIR, logger
...
- **Should `Deployment Guide` be split into smaller, more focused modules?**
